...
public class AppPosVerticle extends Application {
            ...
            if (product_dict.get(item_id).getCategory().equals(category)) {
                ...
                btn.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        addToCart(item_id);
                        //order_list.add(new Order("p-109", "新增的麵食", 30, 1));
    ...
    public TilePane getMenuSelectionContainer() {
        ...
        //定義"炸物類"按鈕
        Button btnCoffee = new Button("炸物");
...
//                TextInputDialog dialog = new TextInputDialog("p-109");
//                dialog.setTitle("訂單號");
//                dialog.setHeaderText("輸入新的訂單號");
//                dialog.setContentText("請輸入訂單號:");
//
//                // 获取用户输入的值
//                Optional<String> result = dialog.showAndWait();
//                result.ifPresent(orderId -> {
//                    // 使用用户输入的订单号创建新的OrderDetail
//                    order_list.add(new OrderDetail(orderId, "新增的麵食", 30, 1));
//                    System.out.println("新增一筆，訂單號: " + orderId);
//                });
                //新增一筆
    ...
    public void initializeOrderTable() {
        ...
        order_item_qty.setOnEditCommit(event -> {
            ...
            OrderDetail target = event.getTableView().getItems().get(row_num); //取得該筆麵食的參考位址
